...
export const DEFAULT_WISHES = [
  ...
  { text: "最好的熹，见字如晤，今年真的是发生了很多事情的一年呢。我好像终于学会了及时止损，拥有了大刀阔斧斩断消耗自己的关系的决心，无论是爱情还是友情。代价是，冻结了我的期待、相信和热情。于是我把自己蜷缩起来度过这个秋冬，感受平和。我有默默想念很多次打个车就去你家过周末的时刻，在沙漠里看星空的时刻，一起蹦了不知道多少场迪...也在适应不擅长的异地关系。慢慢学会接受关系的“平淡”，荣亲的珍贵在与细水长流。其实我觉得咱们俩都是情感内敛，报喜不报忧的类型。但如果你需要我，我一直都在。春天就要来啦，我们都会幸福的！爱你的JBL" }
];
